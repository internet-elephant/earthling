...
All entries are stored in the app's private sandbox container on your Mac. No entry or photo is transmitted to any server, not to Internet Elephant, and not to any third party. No accounts are required. Your files remain readable plain text with or without the app.
...
Earthling is a trademark of Internet Elephant. Forks, please release your version under a different name.
